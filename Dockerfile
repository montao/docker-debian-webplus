FROM debian
RUN apt update && apt install -y sudo g++ make ccache libjsoncpp-dev libjson-c-dev libssl-dev postgresql-server-dev-11 postgresql-client-11 postgresql-11 libpqxx-dev libconfig++-dev libglibmm-2.4-dev dos2unix git cmake curl locate libcurl4-openssl-dev
